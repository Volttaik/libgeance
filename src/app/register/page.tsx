          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              <svg width="28" height="38" viewBox="0 0 300 400" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(0 1px 4px rgba(0,0,0,0.18))" }}>
                <defs>
                  <linearGradient id="rg-t" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#3a3a3a"/><stop offset="100%" stopColor="#1a1a1a"/></linearGradient>
                  <linearGradient id="rg-lc" x1="100%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#6a6a6a"/><stop offset="100%" stopColor="#4a4a4a"/></linearGradient>
                  <linearGradient id="rg-rc" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#121212"/><stop offset="100%" stopColor="#0a0a0a"/></linearGradient>
                  <linearGradient id="rg-ll" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#888"/><stop offset="100%" stopColor="#666"/></linearGradient>
                  <linearGradient id="rg-lr" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#444"/><stop offset="100%" stopColor="#2a2a2a"/></linearGradient>
                  <linearGradient id="rg-pl" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#aaa"/><stop offset="100%" stopColor="#888"/></linearGradient>
                  <linearGradient id="rg-pr" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#555"/><stop offset="100%" stopColor="#333"/></linearGradient>
                </defs>
                <polygon points="150,15 65,108 235,108" fill="url(#rg-t)" stroke="rgba(255,255,255,0.2)" strokeWidth="0.8"/>
                <polygon points="150,15 5,195 65,108" fill="url(#rg-lc)" stroke="rgba(255,255,255,0.12)" strokeWidth="0.8"/>
                <polygon points="150,15 235,108 295,195" fill="url(#rg-rc)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.8"/>
                <polygon points="65,108 5,195 150,195" fill="url(#rg-ll)" stroke="rgba(255,255,255,0.08)" strokeWidth="0.6"/>
                <polygon points="235,108 150,195 295,195" fill="url(#rg-lr)" stroke="rgba(255,255,255,0.15)" strokeWidth="0.6"/>
                <polygon points="5,195 150,395 150,195" fill="url(#rg-pl)" stroke="rgba(255,255,255,0.06)" strokeWidth="0.6"/>
                <polygon points="150,195 150,395 295,195" fill="url(#rg-pr)" stroke="rgba(255,255,255,0.1)" strokeWidth="0.6"/>
